...
from libs.sendrequests import SendRequests
from libs.writeexcel import WriteExcel
#禁用安全请求警告
import urllib3
...
class Demo_API(unittest.TestCase):
    ...
    def test_api(self,data):
        ...
        print("请求方式: {0}，请求URL: {1}".format(data['method'],data['url']+data['path']))
